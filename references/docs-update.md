...
| `EXAMPLES.md` + `examples/` | `EXAMPLES.md` is an index; `examples/` holds runnable code samples split per feature — Web Auth, Credentials Manager, Authentication API, MFA, My Account API, Logging, Advanced Features | ✅ present |
...
| DPoP behaviour changes (key generation, nonce handling, logout) | `examples/web-auth.md` (DPoP) and `examples/authentication-api/dpop.md` |
| My Account API methods added, removed, or promoted from EA to GA | `examples/my-account-api.md` |
