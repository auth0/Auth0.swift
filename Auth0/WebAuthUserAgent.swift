...
public protocol WebAuthUserAgent {
    ...
    /// Auth0.swift will call this method after the callback URL was received and processed, or after the user cancelled the operation, or after any other error occurred.
    ///
