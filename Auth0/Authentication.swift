...
public extension Authentication {
    ...
    func login(email: String, code: String, audience: String? = nil, scope: String = defaultScope, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(email: email, code: code, audience: audience, scope: scope, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    func login(phoneNumber: String, code: String, audience: String? = nil, scope: String = defaultScope, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(phoneNumber: phoneNumber, code: code, audience: audience, scope: scope, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    func login(usernameOrEmail username: String, password: String, realmOrConnection realm: String, audience: String? = nil, scope: String = defaultScope, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(usernameOrEmail: username, password: password, realmOrConnection: realm, audience: audience, scope: scope, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    @available(*, deprecated, message: "This method is deprecated and will be removed in the next major version. Use the MFAClient protocol APIs instead. See MFAClient.swift for the new MFA operations.")
    func login(withOTP otp: String, mfaToken: String, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(withOTP: otp, mfaToken: mfaToken, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    @available(*, deprecated, message: "This method is deprecated and will be removed in the next major version. Use the MFAClient protocol APIs instead. See MFAClient.swift for the new MFA operations.")
    func login(withOOBCode oobCode: String, mfaToken: String, bindingCode: String? = nil, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(withOOBCode: oobCode, mfaToken: mfaToken, bindingCode: bindingCode, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    @available(*, deprecated, message: "This method is deprecated and will be removed in the next major version. Use the MFAClient protocol APIs instead. See MFAClient.swift for the new MFA operations.")
    func login(withRecoveryCode recoveryCode: String, mfaToken: String, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.login(withRecoveryCode: recoveryCode, mfaToken: mfaToken, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }
    ...
    func loginDefaultDirectory(withUsername username: String, password: String, audience: String? = nil, scope: String = defaultScope, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.loginDefaultDirectory(withUsername: username, password: password, audience: audience, scope: scope, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }
    ...
    func codeExchange(withCode code: String, codeVerifier: String, redirectURI: String, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.codeExchange(withCode: code, codeVerifier: codeVerifier, redirectURI: redirectURI, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }

    func renew(withRefreshToken refreshToken: String, audience: String? = nil, scope: String? = nil, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<Credentials, AuthenticationError> {
        return self.renew(withRefreshToken: refreshToken, audience: audience, scope: scope, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }
    ...
    func ssoExchange(withRefreshToken refreshToken: String, issuer: String = "", leeway: Int = 60000, maxAge: Int? = nil, nonce: String? = nil, organization: String? = nil) -> Request<SSOCredentials, AuthenticationError> {
        return self.ssoExchange(withRefreshToken: refreshToken, issuer: issuer, leeway: leeway, maxAge: maxAge, nonce: nonce, organization: organization)
    }
