...
typealias CompletionHandler = ASWebAuthenticationSession.CompletionHandler
...
extension WebAuthentication {
    ...
    static let completionHandler: (_ callback: @escaping WebAuthProviderCallback) -> CompletionHandler = { callback in
        return {
