...
@property (nonatomic, readonly, strong) NSDate * _Nullable expiresAt;
...
+ (A0JWT * _Nullable)decode:(NSString * _Nonnull)jwtValue error:(NSError * _Nullable * _Null_unspecified)error;
@end
