...
Once a platform version becomes unsupported, dropping it from Auth0.swift **will not be considered a breaking change**, and will be done in a **minor** release. For example, iOS 15 will cease to be supported when iOS 19 gets released, and Auth0.swift will be able to drop it in a minor release.
